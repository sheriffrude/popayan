var tablaGrupos = null;

var listarGrupoTarifario = function () {
    return {
        //Carga inicial que recibe las url de cada CRUD
        init: function () {
            listarGrupoTarifario.construirTabla();
        },
        ...
        construirTabla: function () {
            ...
            tablaGrupos = $("#tabla-grupos-tarifarios").DataTable({
                "ajax": {
                    "url": urlListar,
                    "type": "POST",
                    "data": function (d) {
