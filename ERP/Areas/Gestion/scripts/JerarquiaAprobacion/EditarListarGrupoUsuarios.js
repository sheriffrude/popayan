var JerarquiaAprobacionListarGrupoUsuarios = {
    ...
    $TABLA: null,
    OnLoad: function () {
        JerarquiaAprobacionListarGrupoUsuarios.EditarTabla();
    },
    EditarTabla: function () {
    ...
    Eliminar: function (usuarioId) {
        ...
        for (var i = 0; i < EditarJerarquiaAprobacion.GRUPOS_JERARQUIA.length; i++) {
            if (EditarJerarquiaAprobacion.GRUPOS_JERARQUIA[i].Id == JerarquiaAprobacionListarGrupoUsuarios.GRUPO_ID) {
                EditarJerarquiaAprobacion.GRUPOS_JERARQUIA[i].Usuarios = JerarquiaAprobacionListarGrupoUsuarios.DATA;
                break;
            }
        }
