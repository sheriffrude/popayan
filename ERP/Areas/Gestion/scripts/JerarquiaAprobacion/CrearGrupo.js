var JerarquiaAprobacionGrupoCrear = {
            ...
            "columns": [
                { "data": "Nombre" },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return '<button type="button" class="btn btn-danger btn-sm" onclick="JerarquiaAprobacionGrupoCrear.RemoverUsuario(' + data + ')" >' +
    ...
    AgregarGrupo: function () {
        ...
        if ($form.valid()) {
            ...
            CrearJerarquiaAprobacion.AgregarGrupo(data);
            Utils._CloseModal();
        }
    },
    Cancelar: function () {
