...
var PresupuestoItemListar = {
    ...
    CrearTabla: function () {
        ...
        console.log(URL_PRESUPUESTO_ITEM_LISTAR);
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        ...
                        var html = '<div class="input-group">' +
                            ...
                            '<input type="text" class="form-control input_valor_unitario_interno_item" ' + disabled + ' data-format-price="" data-item-id="' + full.Id + '"  value="' + valor + '" data-valor="' + data + '" onkeyup="PresupuestoItemEditar.OnKeyUpValorUnitarioInterno(this, ' + full.Id + ')" />' +
                            '</div>';
                        return html;
                    }
                },
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        var valor = data;
                        for (var i = 0; i < PresupuestoItemListar.LISTA_ITEMS_MODIFICADOS.length; i++) {
                            if (PresupuestoItemListar.LISTA_ITEMS_MODIFICADOS[i].Id == full.Id && !Validations._IsNull(PresupuestoItemListar.LISTA_ITEMS_MODIFICADOS[i].CostoOC))
                                valor = PresupuestoItemListar.LISTA_ITEMS_MODIFICADOS[i].CostoInterno;
                        }
                        var html = '<div class="input-group">' +
                            '<label class="input-group-addon">$</label>' +
                ...
                //Externo
                {
                    ...
                    "render": function (data, type, full, meta) {
                        ...
                        return '<textarea class="form-control textarea_descripcion_externo_item" ' + disabled + ' data-item-id="' + full.Id + '" data-valor="' + data + '" onkeyup="PresupuestoItemEditar.OnChangeDescripcionExterna(this, ' + full.Id + ')"  >' + valor + '</textarea>';
                    }
                },
                {
                ...
                {
                    "data": "ImpuestosExterno",//Impuestos Externos
                    "orderable": false,
                    "searchable": false,
                    "render": function (data, type, full, meta) {
                        var disabled = (!PresupuestoConsultar.PRESUPUESTO_EDITABLE || full.Bloquear) ? "disabled='disabled'" : "";
    ...
    ConsultarRentabilidadPresupuesto: function () {
        ...
        RequestHttp._Post(URL_CONSULTAR_RENTABILIDAD_PRESUPUESTO, parameters, null, function (data) {
            ...
            $totalRentabilidadBruta.val(data.data.SubTotalExterno - data.data.SubTotalExterno);
